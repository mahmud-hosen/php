                 ...
                 if (count($results->getCourses()) == 0) {
                    ...
                    foreach ($results->getCourses() as $course) {  ?>
                        <div class="col-xl-3 col-md-3 mb-3 ">
                           <a class="text-decoration-none"  href="quickstart.php?couse=<?php printf("%s", $course->getId()) ?>">
                                ...
                                <div class="card border-success border-left-primary shadow h-100 py-3">
                                    <div class="card-body hover">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div
                                                    class="h6 text-center font-weight-bold text-primary text-uppercase mb-1">
